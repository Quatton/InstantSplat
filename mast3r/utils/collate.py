...
cat_collate_fn_map[type(None)] = (
    lambda _, **kw: None
)  # When some Nones, simply return a single None
    ...
    *,
    ...
    if isinstance(elem, collections.abc.Mapping):
        try:
            ...
            return {
                key: cat_collate([d[key] for d in batch], collate_fn_map=collate_fn_map)
                for key in elem
            }
