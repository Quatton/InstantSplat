...
def main(
    ...
    save_intrinsics(
        sparse_1_path, focals, org_imgs_shape, imgs.shape, save_focals=False
    )
    print(
        f"[INFO] MASt3R Reconstruction is successfully converted to COLMAP files in: {str(sparse_1_path)}"
    )
