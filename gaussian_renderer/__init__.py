...
import torch
import math
import diff_surfel_rasterization as ds
...
def render(
    ...
    d = dg if not pc.surf else ds

    raster_settings = d.GaussianRasterizationSettings(
    ...
    rasterizer = d.GaussianRasterizer(raster_settings=raster_settings)
    ...
    rets = {
        ...
        "viewspace_points": screenspace_points if not pc.surf else means2D,
