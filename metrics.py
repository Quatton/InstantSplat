    ...
    for scene_dir in args.model_paths:
        try:
            ...
            for method in os.listdir(test_dir):
                ...
                print("  Rel_err: {:>12.7f}".format(torch.tensor(rel_errs).mean(), ))
                print("  Tau: {:>12.7f}".format(torch.tensor(taus).mean(), ))
                ...
                pose_optimized = np.load(pose_path / "pose_optimized.npy")
                ...
                with open(pose_path / "pose_eval.txt", "w") as f:
                    f.write(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--surf", action="store_true", default=False, help="2DGS"
    )
